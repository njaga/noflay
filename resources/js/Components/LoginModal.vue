      ...
      <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all duration-300 ease-out scale-95 hover:scale-100">
        <div class="p-8">
          <div class="flex justify-between items-center mb-8">
            <h2 class="text-3xl font-extrabold text-indigo-800 bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-600">Connexion Noflay</h2>
          ...
          <form @submit.prevent="submitLogin" class="space-y-6">
            ...
            <div class="flex items-center justify-between text-sm">
              <label class="flex items-center text-gray-600 hover:text-indigo-600 cursor-pointer transition-colors duration-200">
                <input
                  type="checkbox"
                  v-model="rememberMe"
              ...
              <a href="#" class="text-indigo-600 hover:text-indigo-800 transition-colors duration-200">Mot de passe oublié ?</a>
            </div>
            <button
              type="submit"
