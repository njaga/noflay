<template>
    <div class="filter-container mb-6"> <!-- Ajout de la classe mb-6 pour ajouter une marge en bas -->
  ...
  <style scoped>
  .filter-container {
    margin-bottom: 1.5rem; /* Ajoute une marge en bas pour espacer le filtre du header */
  }
  </style>
