<template>
    <form @submit.prevent="$emit('submit', demoForm)" class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
      <div class="sm:col-span-2">
        <label for="name" class="block text-sm font-medium text-gray-700">Nom complet</label>
        <div class="mt-1">
          <input type="text" id="name" v-model="demoForm.name" required
      ...
      <div class="sm:col-span-2">
        ...
        <div class="mt-1">
          <input type="email" id="email" v-model="demoForm.email" required
            class="py-3 px-4 block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md" />
        </div>
      </div>
      <div class="sm:col-span-2">
        ...
        <div class="mt-1">
          <textarea id="message" v-model="demoForm.message" rows="4" required
