                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="tenant_id" v-model="form.tenant_id" required
                            ...
                            <template v-if="form.contract_type === 'commercial'">
                                <div class="space-y-2">
                                    <label for="company" class="text-sm font-medium text-gray-700">Nom de la société</label>
                                    <input type="text" id="company" v-model="form.company"
                                        class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition duration-200 ease-in-out transform hover:scale-105" />
                                </div>
                                <div class="space-y-2">
                                    <label for="representative" class="text-sm font-medium text-gray-700">Nom du représentant</label>
                                    <input type="text" id="representative" v-model="form.representative"
                                        class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition duration-200 ease-in-out transform hover:scale-105" />
                                </div>
                                <div class="space-y-2">
                                    <label for="trade_register" class="text-sm font-medium text-gray-700">Registre de commerce</label>
                            ...
                            <div class="space-y-2">
                                <label for="start_date" class="text-sm font-medium text-gray-700">Date de début du contrat</label>
                            ...
                            <div class="space-y-2">
                                <label for="caution_amount" class="text-sm font-medium text-gray-700">Montant de la caution</label>
                            ...
                            <!-- Numéro de dossier -->
                            <div class="space-y-2">
                                <label for="file_number" class="text-sm font-medium text-gray-700">Numéro de dossier</label>
