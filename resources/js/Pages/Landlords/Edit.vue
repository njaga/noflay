<template>
    <AppLayout title="Modifier un bailleur">
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label
                                    ...
                                    class="text-sm font-medium text-gray-700"
                                    >Pourcentage à donner à l'agence</label
                                >
                                <input
                            ...
                            <div class="space-y-2">
                                <label
                                    ...
                                    class="text-sm font-medium text-gray-700"
                                    >Durée de contrat avec l'agence (en
                                    mois)</label
                                >
                                <input
                        ...
                        <div class="flex justify-end space-x-4">
                            <Link
                                ...
                                class="px-6 py-3 bg-gray-300 text-gray-700 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                            >
                                Annuler
                            </Link>
                            <button
...
const form = useForm({
    first_name: props.landlord.first_name,
    last_name: props.landlord.last_name,
    address: props.landlord.address,
    phone: props.landlord.phone,
    email: props.landlord.email,
    identity_number: props.landlord.identity_number,
    identity_expiry_date: props.landlord.identity_expiry_date,
    agency_percentage: props.landlord.agency_percentage,
    rental_percentage: props.landlord.rental_percentage,
    contract_duration: props.landlord.contract_duration,
    company_id: props.landlord.company_id,
    attachments: [],
});
...
const submit = () => {
    form.put(route("landlords.update", props.landlord.id), {
        ...
        preserveState: true,
        onSuccess: () => {
            alert("Bailleur mis à jour avec succès");
        },
        onError: (errors) => {
            console.error(errors);
            alert("Une erreur est survenue lors de la mise à jour du bailleur");
        },
    });
};
</script>
