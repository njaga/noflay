<template>
    <AppLayout title="Grand Livre Caisse">
        <div class="grand-livre-container">
            <!-- Filtres -->
            <div class="filters-container mb-6 p-4 bg-white rounded-lg shadow-md">
                ...
                <div v-if="showAdvancedFilters" class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <select v-model="filters.landlord_id" id="landlord"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    ...
                    <div>
                        ...
                        <select v-model="filters.tenant_id" id="tenant"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    ...
                    <div>
                        ...
                        <select v-model="filters.property_id" id="property"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
            ...
            ">
                ...
                <div class="md:hidden space-y-4">
                    <div v-for="transaction in transactions.data" :key="transaction.id"
                        ...
                        <button @click="openModal(transaction)" class="mt-2 text-indigo-600 hover:text-indigo-800">
                            Voir les détails
                        </button>
                    </div>
                </div>
            ...
            <div v-if="transactions && transactions.meta" class="mt-6">
                <Pagination :data="transactions" @pagination-change-page="changePage" />
            </div>
                            ...
                            <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                                ...
                                <DialogPanel
                                    ...
                                    <div class="mt-2 space-y-4">
                                        ...
                                        <div class="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                                            <span class="text-sm font-medium text-gray-500">Locataire</span>
                                            <span class="text-sm text-gray-900">{{
                                        ...
                                        <div class="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                                            <span class="text-sm font-medium text-gray-500">Propriété</span>
                                            <span class="text-sm text-gray-900">{{
                                        ...
                                        " class="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                                            <span class="text-sm font-medium text-gray-500">Raison du
                                                remboursement</span>
                                            <span class="text-sm text-gray-900">{{
                                                getRefundReason(
...
const getTypeClass = (type) => {
    ...
    return `px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${classes[type] || "bg-gray-100 text-gray-800"
        }`;
};
