<template>
    <AppLayout title="Modifier une Dépense">
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <h2 class="text-3xl font-bold mb-8 text-gray-800">Modifier une Dépense</h2>
...
const form = ref({
    property_id: expense.value.property_id,
...
const submit = () => {
    router.put(route('expenses.update', expense.value.id), form.value);
};
</script>
